...
const BASE = "https://raw.githubusercontent.com/jgh041015-boop/jeongahyun.github.io/main/";
  ...
  const works = [
    {
      ...
      img: `${BASE}gana_movie.png`,
      layout: "custom-gana",
      gallery: [
        { url: `${BASE}gana_gift.png`, width: 1125, height: 958, label: "Gift" },
        { url: `${BASE}gana_yt.png`, width: 960, height: 720, label: "YouTube" },
        { url: `${BASE}gana_movie.png`, width: 1771, height: 1168, label: "Movie" },
        { url: `${BASE}gana_interpark.png`, width: 660, height: 1173, label: "Interpark" },
        { url: `${BASE}gana_reels.png`, width: 1080, height: 2340, label: "Reels" }
      ]
    },
    {
      title: "<방문자: The Guest>",
      ...
      img: `${BASE}guest_main.png`,
      youtubeUrl: "https://youtu.be/6wdYSdxIA7o?si=eTYyyQlRJxO9z9gS",
      gallery: [
        { type: 'image', label: 'A2 Poster', url: `${BASE}guest_poster.png`, width: 420, height: 592 },
      ]
    },
    {
      title: "<나루와 상이>",
      ...
      img: `${BASE}naru_main.png`,
       gallery: [
        { url: `${BASE}naru_1.png`, width: 16, height: 9 },
        { url: `${BASE}naru_2.png`, width: 16, height: 9 },
        { url: `${BASE}naru_3.png`, width: 16, height: 9 },
        { url: `${BASE}naru_4.png`, width: 16, height: 9 },
        { url: `${BASE}naru_5.png`, width: 16, height: 9 },
       ]
    },
    {
      title: "알쓸한잡 카드뉴스",
    ...
    },
    {
      ...
      img: `${BASE}danyang_reels.png`,
      youtubeUrl: "https://youtube.com/shorts/4FxOlRH1ERU?si=kqqCywC3ZwkxuTcV",
      gallery: [
        { url: `${BASE}danyang_reels.png`, width: 9, height: 16, label: "Reels" }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen selection:bg-accent selection:text-white">
      ...
      <header className="fixed top-0 left-0 w-full z-50 mix-blend-difference px-6 py-8 md:px-12 flex justify-between items-center">
        <h1 className="font-display text-2xl tracking-tighter uppercase">Jeon Ga Hyun</h1>
      ...
      <main className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <section id="profile" className="mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="bg-zinc-900/50 p-8 md:p-12 brutal-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-zinc-900 border border-white/5 flex flex-col items-center gap-4 group hover:border-accent/50 transition-colors">
              ...
              <div key={idx} className="group">
                <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-zinc-300 mt-3 font-medium bg-white/5 px-3 py-1.5 rounded-sm inline-block border border-white/10 -ml-3">{work.items}</p>
                    <div className="flex gap-3 mt-4">
                      {work.instagramUrl && (
                        <a 
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900 border border-white/10 hover:border-accent/50 transition-all group"
                        >
                ...
                <div className={`grid gap-4 ${
                  ...
                  {work.gallery.map((item, i) => {
                    ...
                    if (work.layout === 'custom-gana') {
                      if (i < 3) gridSpan = 'md:col-span-1';
                      else gridSpan = 'md:col-span-1';
                    } else if (idx === 1 && i === 0) {
                    ...
                    return (
                      <motion.div 
                        ...
                        className={`relative overflow-hidden brutal-border bg-zinc-900 flex items-center justify-center ${gridSpan} ${hasDimensions ? '' : 'aspect-square'}`}
